...
instance Describable Zip where describe (Zip f) = show f
instance Importable Zip where runImport z = undefined
instance Deleteable Zip where delete (Zip f) = removeFile f
